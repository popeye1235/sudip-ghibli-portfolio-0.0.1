...
const ContactSection = () => {
  ...
  return (
    <section
      id="contact"
      className="min-h-screen flex items-center py-20 bg-muted/10"
    >
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          {/* Header */}
          <div className="text-center mb-8 space-y-3">
            ...
            {mode === "story" ? "A Quiet Knock on the Door 🚪" : "Get In Touch"}
            </h2>
            <h3 className="text-3xl md:text-5xl font-bold">
            {mode === "story" ? "If Our Paths Align 🌱" : "Let’s Work Together"}
            </h3>
            <Separator className="w-24 h-1 bg-primary rounded-full mx-auto mt-4" />
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground text-lg">
                  {mode === "story" ? (
                    <>
                      Whether it’s a whisper of collaboration or a friendly
                      hello carried on the wind 🌿 — I’m open to new journeys.
                      <br />
                      <br />
                      My lantern 🏮 is lit for thoughtful freelance paths,
                      long-term roles, and conversations that grow into
                      something meaningful.
                    </>
                  ) : (
                    <>
                      I’m open to frontend engineering roles, freelance
                      opportunities, and serious collaborations.
                      <br />
                      <br />
                      If you’re looking for someone who values clean code,
                      scalable UI systems, and long-term maintainability,
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  {mode === "story"
                    ? "If words come easier than forms, begin here ✍️"
                    : "Use the form below and I’ll respond as soon as possible."}
                </p>
              </div>
